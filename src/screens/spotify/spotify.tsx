...
import Spotify from '@assets/spotify/spotify.svg';
      ...
      <View className="flex-1 px-5 flex flex-col justify-between">
        <View className="flex flex-col">
          <View className="mb-[58px] pt-[45px]">
            <Text className="text-2xl font-bold text-[#E3E3E8]">Spotify를</Text>
            <Text className="text-2xl font-bold text-[#E3E3E8]">연동할까요?</Text>
          </View>
